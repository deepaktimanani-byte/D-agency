...
export function Footer({ settings }: FooterProps) {
  ...
  const socials = [
    ...
    { icon: InstagramIcon, href: settings.social_instagram, label: "Instagram" },
    { icon: TwitterIcon, href: settings.social_twitter, label: "Twitter" },
    { icon: YoutubeIcon, href: (settings as Record<string, string>).social_youtube, label: "YouTube" },
  ].filter((s) => s.href);
    ...
    <footer className="bg-bg-dark text-white">
      ...
      <div className="container-main py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-1 flex flex-col gap-5">
          ...
          <p className="text-white/60 text-sm leading-relaxed">
            {settings.footer_tagline ||
              "Your end-to-end partner for digital growth."}
          </p>
          {/* Contact */}
        ...
        <div className="flex flex-col gap-4">
          <h4 className="font-bold text-sm uppercase tracking-widest text-white/50">
            Company
          </h4>
